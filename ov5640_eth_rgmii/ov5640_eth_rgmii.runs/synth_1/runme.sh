...
HD_PWD='F:/F_prj/ov5640_eth_rgmii/ov5640_eth_rgmii.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_eth_rgmii.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ov5640_eth_rgmii.tcl
