...
HD_PWD='F:/F_prj/ov5640_eth_rgmii/ov5640_eth_rgmii.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_eth_rgmii.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov5640_eth_rgmii.tcl -notrace
