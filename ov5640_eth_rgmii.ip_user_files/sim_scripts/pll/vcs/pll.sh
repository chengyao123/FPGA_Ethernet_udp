...
#
# Generated by Vivado on Mon Apr 15 20:49:42 +0800 2024
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../ov5640_eth_rgmii.srcs/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../ov5640_eth_rgmii.srcs/sources_1/ip/pll/pll.v" \
  2>&1 | tee -a vlogan.log
